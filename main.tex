...
\begin{frame}{I principi di Shannon}
  ...
  \begin{itemize}
    \item Confusione: la chiave deve essere ben distribuita (ogni bit del cifrato dovrebbe dipendere da ogni bit della chiave).
    \item Diffusione: il messaggio (ogni bit del cifrato dovrebbe dipende da ogni bit del messaggio).
  \end{itemize}
